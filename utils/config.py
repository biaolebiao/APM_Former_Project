...
# 2. split_data.py 配置
ALL_DATA_CSV = os.path.join(DATA_DIR, "clinical/all_data.csv")
TRAIN_CSV = os.path.join(DATA_DIR, "clinical/train.csv")
VAL_CSV = os.path.join(DATA_DIR, "clinical/val.csv")
TEST_CSV = os.path.join(DATA_DIR, "clinical/test.csv")
SPLIT_SEED = 42
TRAIN_RATIO = 0.8
...
PREPROCESS_CONFIG = {
    "input_root": os.path.join(DATA_DIR, "raw/sMCI/nii"),
    ...
    "output_dir": os.path.join(DATA_DIR, "preprocessed/sMCI_processed"),
    "use_parallel": False,
    "max_workers": None,
    "overwrite": False,
}
